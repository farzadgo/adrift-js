...
// Admin.prototype.deleteUser = (u) => {
//   users = users.filter(user => {
//     return user.email != u.email;
//   })
// }

// var userOne = new User('farzadgo@gmail.com', 'Farzie');
// var userTwo = new User('fargo.live.de', 'Feri');
// var admin = new Admin('farzadesign@gmail.com', 'Farzad');
// console.log(userOne);
// userOne.login();
// var users = [userOne, userTwo, admin];


// <ul class="preview-list boxes">
//   ${Array(obj.records.length).fill().map((item, i) => `
//   ${obj.records[i] ? `<li class="box-item empty"></li>` : `<li class="box-item full"></li>` }
...
// <ul class="preview-item list dls">
//   ${Array(obj.records.length).fill().map((item, i) => `
//     ${obj.records[i] == null ? `<li class="preview-list-item"><a> e </a></li>` : `<li class="preview-list-item"><a class="download-link "> f </a></li>`}
//  `).join('')}
// </ul>
